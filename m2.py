...
from keras.layers import GRU, LSTM, Bidirectional, Dense, Dropout, BatchNormalization
...
# Load the model
model = load_model("music_generation_model_genI_complex_V1.h5")
...
model.save("music_generation_model_super_complex_V1.h5")
